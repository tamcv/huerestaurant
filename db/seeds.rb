...
FoodItem.create!([
  ...
  {name: "Com hen", description: "This is really good breakfast from Hue", price: "10000.0", section_id: 2, image_url: "/images/comhen.jpg", count_views: 1},
  {name: "Bun Bo", description: "Delicious food from Hue city", price: "22000.0", section_id: 2, image_url: "/images/bunbo.jpg", count_views: 1},
  {name: "Pho", description: "Delicious Hanoi Food", price: "32000.0", section_id: 2, image_url: "/images/pho.jpg", count_views: 1},
  ...
  {name: "Ca kho to", description: "Clay pots are kind of like the Asian cousin of the Dutch oven. The thick clay walls retain heat and moisture, helping to soften and caramelize meats when braised. In this dish, the fish develops a sweet-savory gooeyness from the sugar and fish sauce over the course of the long braise. \"This reminds me of my grandma,\" said my Vietnamese friend who grew up eating this classic comfort food.", price: "32000.0", section_id: 3, image_url: "/images/cakhoto.jpg", count_views: 1},
  {name: "Lau Bo", description: "This is a beef hotspot!", price: "120000.0", section_id: 3, image_url: "/images/laubo.jpg", count_views: 0},
  {name: "Com chien", description: "This is Mixed Fried rice ", price: "10000.0", section_id: 3, image_url: "/images/comchien.jpg", count_views: 0},
  ...
  {name: "Ga nuong mat ong", description: "", price: "200000.0", section_id: 3, image_url: "/images/galuoc.jpg", count_views: 9},
  ...
  {name: "Com Tam", description: "Great dinner from the South of VN", price: "30000.0", section_id: 3, image_url: "/images/comtam.jpg", count_views: 1},
  {name: "Banh My", description: "This is one of famous food of VN", price: "12000.0", section_id: 2, image_url: "/images/banhmy.jpg", count_views: 3},
